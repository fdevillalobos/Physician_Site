...
(function() {
  $(document).ready(function() {
    $("#basic_search").on("click", "button", function(event) {
      $("#basic_search").hide();
      $("#advanced_search").fadeIn();
    });
    $("#advanced_search").on("click", "button", function(event) {
  ...
  jQuery(function() {
    ...
    return $('#physician_country_id').change(function() {
      var country, options;
      ...
      if (options) {
        ...
        return $('#physician_state_id').parent().parent().show();
      } else {
        $('#physician_state_id').empty();
        return $('#physician_state_id').parent().parent().hide();
      }
    });
  });
