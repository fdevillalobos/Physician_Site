...
if Rails.env.development?
  ...
  CSV.foreach("physician_input_first_10.csv") do |row|
    ...
    if csv_gender == "M" and csv_credential == "MD"
      ...
      Physician.where( name: "Donald Draper", gender: female_gender, credential: md_credential, email: "insideloop@draper.com", state: penn_state, country: us_country, street: "Seeds Street", city: "Seeds City").first_or_create
